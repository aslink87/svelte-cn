export async function load() {
  const data = [
    ...
    {
      title: 'How much of my financial donation goes directly to help those in need?',
      content:
    ...
    },
    {
      ...
      content:
        'Volunteers are an important part of our mission. We occasionally need volunteers to help with food drives, newsletters and other tasks. If volunteering interests you, leave your contact info',
      link: '/donate#donate-volunteer',
    },
    {
