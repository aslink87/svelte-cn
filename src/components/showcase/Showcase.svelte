...
<section class="showcase component mb-0 h-fit bg-surface-500/60" data-testid="showcase">
  ...
  <h2 class="heading h2-primary my-8 rounded-md bg-primary-800">
    We provide a safe place for people in our community who need food, rent and utility assistance,
    education, or other resources to help create stability in their lives.
  </h2>
  {#each cards as card}
